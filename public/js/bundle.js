...
var displayMap = exports.displayMap = function displayMap() {
  ...
  if (mapBox) {
    var locationsData = JSON.parse(document.getElementById('map').dataset.locations);
    ...
    var map = L.map('map').setView([latStart, longStart], 8);
...
exports.logouts = exports.login = void 0;
...
var logouts = exports.logouts = /*#__PURE__*/function () {
...
(0, _mapbox.displayMap)();
var loginForm = document.querySelector('.form--login');
var logOutBttn = document.querySelector('.nav_el--logout');
...
if (logOutBttn) {
  logOutBttn.addEventListener('click', _login.logouts);
}
if (userDataForm) {
